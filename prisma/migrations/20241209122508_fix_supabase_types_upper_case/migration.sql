/*
  ...
  - The values [String,Int,BigInt,Float,Decimal,Boolean,Json,Bytes] on the enum `SupabaseColumnType` will be removed. If these variants are still used in the database, this will fail.

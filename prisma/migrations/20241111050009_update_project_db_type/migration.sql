/*
  ...
  - The values [NULL] on the enum `SQliteColumnType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "SQliteColumnType_new" AS ENUM ('INTEGER', 'TEXT', 'REAL', 'BLOB');
